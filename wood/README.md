# C19-CZ fatal infections dynamics inferred by Wood's stochastic model
**Based on paper & R scripts by Wood**: https://onlinelibrary.wiley.com/doi/full/10.1111/biom.13462
There are only 2 inputs:  **the daily number od C19 related deaths** and **onset to death distribution**
Deaths are taken from closed UZIS hospital data (data range 19.3.2020 - 29.4.2021)

## Onset to death distributions
Comparison of real data & fits based on UZIS closed datasets, together with distributions used in Wood's paper (Wu,Linton,Verity)
